...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filt_df = filt_df.groupby(['Launch Site', 'class']).size().reset_index()
        filt_df.rename(columns={0:'class count'}, inplace=True)
        fig = px.pie(filt_df,
        values='class count',
        names='class', 
